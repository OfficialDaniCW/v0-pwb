  ...
  const steps = [
    {
      ...
      description:
        "Message us with your property details and photos. We'll ask the right questions to understand your needs.",
    },
    {
      number: "02",
      icon: ClipboardCheck,
      ...
      description:
        "We visit to evaluate surfaces, drainage, access, and specific challenges. No obligation, just honest advice.",
    },
    {
      number: "03",
      icon: FileText,
    ...
    },
    {
      ...
      description:
        "Our biocide-trained team uses the right techniques and PowerUps products for your specific surfaces.",
    },
    {
      number: "05",
      icon: BookOpen,
