  ...
  const services = [
    {
      ...
      price: fmt(rates.gutter?.baseRate, "£8"),
      unit: "/metre",
      typical: `Average 3-bed semi: ${fmt(rates.gutter?.baseRate ? rates.gutter.baseRate * 20 : undefined, "£160")}–${fmt(rates.gutter?.baseRate ? rates.gutter.baseRate * 28 : undefined, "£224")}`,
    ...
    },
    {
      ...
      price: fmt(rates.roof?.baseRate, "£14"),
      unit: "/m²",
      typical: "Average 3-bed semi (inc. scaffold & biocide): £1,250–£1,500",
      features: ["Moss & lichen removal", "Biocide treatment", "Ridge & valley clean", "Scaffold hire included"],
      icon: Home,
      color: "#F59E0B",
    },
    {
      name: "Patio Cleaning",
      description: "Per square metre",
      price: fmt(rates.patio?.baseRate, "£6"),
      unit: "/m²",
      typical: `Average patio 25m²: ${fmt(rates.patio?.baseRate ? rates.patio.baseRate * 25 : undefined, "£150")}–${fmt(rates.patio?.baseRate ? rates.patio.baseRate * 40 : undefined, "£240")}`,
