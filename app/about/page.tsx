    ...
    <>
      <main className="min-h-[100dvh] text-white">
        ...
        <section className="py-20 sm:py-28">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">Meet Dorset's Property Care Brothers</h1>
                ...
                <div className="space-y-8">
                  ...
                  <div className="glass-border rounded-xl p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h3 className="text-2xl font-bold text-white mb-1">Daniel Calvo-Westcott</h3>
                    ...
                    <p className="text-white/70 leading-relaxed">
                      With a background in hands-on property care and a passion for DIY, Daniel oversees the operational
                      side of PowerWash Bros. His biocide qualification and practical problem-solving skills ensure
                      every job is carried out safely, efficiently, and to the highest standard. Daniel's commitment to
                      quality and customer satisfaction drives the company's smooth day-to-day running and
                  ...
                  <div className="glass-border rounded-xl p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h3 className="text-2xl font-bold text-white mb-1">Santos Calvo-Westcott</h3>
                        <p className="text-[#1E90FF] font-medium">Co-Founder</p>
                      </div>
                      <a
                    ...
                    <p className="text-white/70 leading-relaxed">
                      Santos specialises in creating detailed, customer-centred plans that deliver outstanding results
                      for every property. With a strong understanding of Dorset's unique challenges and a keen eye for
                      detail, Santos ensures each project is designed around the customer's needs while achieving the
                      best possible outcome. His focus on communication and tailored solutions helps clients feel
        ...
        <section className="py-16 bg-gradient-to-br from-[#1E90FF]/10 to-transparent">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-2xl font-semibold text-[#1E90FF] mb-8">Exceptional Service. Outstanding Results.</p>
              <p className="text-lg text-white/80 leading-relaxed max-w-3xl mx-auto">
                Choose PowerWash Bros for professional, high-quality exterior cleaning services. We focus on delivering
                the best customer experience with reliable, eco-friendly solutions that leave your property looking its
                absolute best. Our expert team is dedicated to precision, care, and results that last.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6 text-lg text-white/80 leading-relaxed">
                <p>
                  PowerWash Bros started with a simple observation: most property cleaning companies treat every job the
                  same. Cookie-cutter quotes, rushed work, temporary results.
                </p>
                ...
                <p>
                  That's why we invested in biocide training, developed our PowerUps product range, and built our
                  business around the Property-Centred Approach. We don't just clean surfaces; we protect property
                  investments.
                </p>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="glass-border rounded-2xl p-8 text-center">
                  ...
                  <p className="text-white/70 leading-relaxed">
                    We've invested in professional training and certification because we believe in doing things
                    properly. Our biocide expertise means we can tackle organic growth at its source - not just clean
        ...
        <section className="py-16 bg-white/5">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl font-bold text-white mb-12 text-center">Our Philosophy, Mission & Vision</h2>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="glass-border rounded-2xl p-8">
                  ...
                  <p className="text-white/70 leading-relaxed">
                    At PowerWash Bros, we believe that every property deserves the highest level of care and attention.
                    Our philosophy is rooted in delivering exceptional results whilst protecting the environment. We
                    combine expert techniques, eco-friendly products, and a passion for precision to ensure every
                    service enhances the beauty and longevity of your property.
                  </p>
                </div>
                ...
                <div className="glass-border rounded-2xl p-8">
                  ...
                  <p className="text-sm font-semibold text-[#1E90FF] mb-3">To Transform and Protect Every Property</p>
                  <p className="text-white/70 leading-relaxed">
                    At PowerWash Bros, we believe that every property deserves the highest level of care and attention.
                    Our philosophy is rooted in delivering exceptional results whilst protecting the environment. We
                    combine expert techniques, eco-friendly products, and a passion for precision to ensure every
                ...
                <div className="glass-border rounded-2xl p-8">
                  ...
                  <p className="text-white/70 leading-relaxed">
                    We envision becoming Dorset's leading name in exterior property care. By continually innovating our
                    techniques and focusing on sustainable practices, we aim to transform homes and businesses whilst
                    promoting eco-conscious cleaning solutions that benefit our community and the environment.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto leading-relaxed">
                ...
                moss growth in tree-covered areas, historic properties throughout the county. We're invested in making
        ...
        <section className="py-16 bg-white/5">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl font-bold text-white mb-12 text-center">Our Commitment to Excellence</h2>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="glass-border rounded-2xl p-8">
                  ...
                  <p className="text-xs text-white/50">Policy effective date: 01/01/2025 | Review date: 01/01/2026</p>
                </div>
                ...
                <div className="glass-border rounded-2xl p-8">
                  ...
                  <p className="text-white/70 leading-relaxed mb-6">
                    Our Terms of Service govern your use of our website and services. We provide professional exterior
                    cleaning services with clear booking, cancellation, and payment policies designed to protect both
        ...
        <section className="py-20 bg-gradient-to-br from-[#1E90FF] to-[#1E90FF]/80">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-4xl font-bold text-white mb-6">Ready to Experience Property-Centred Care?</h2>
              <Button
                asChild
                size="lg"
