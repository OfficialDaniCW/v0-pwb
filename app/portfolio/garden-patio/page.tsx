...
export const metadata = {
  ...
  description: "See the transformation of a garden patio in Dorset. We removed years of grime and algae to reveal the beautiful natural stone underneath.",
}
...
export default function GardenPatioProject() {
  const project = {
    ...
    location: "Dorset",
    date: "February 2024",
    description: "This garden patio had accumulated significant organic growth and grime over time, obscuring the natural beauty of the paving stones. Our team used our specialized power washing techniques to gently but effectively remove the buildup. The result is a bright, clean, and safe outdoor space that looks brand new.",
    details: [
